...
namespace PortfolioBackend.Services.ContactService
{
    public class ContactService : IContactService
    {
        ...
        public ContactContext SetContacts()
        {
        ...
        public async Task<ContactServiceResponse<GetContactDto>> AddContact(AddContactDto newContact)
        {
            ...
            {
                serviceResponse.Success = false;
                serviceResponse.Message = $"Exception Message: {exception.Message} Inner Exception Message: {exception.InnerException?.Message}";
                return serviceResponse;
            }
        }
